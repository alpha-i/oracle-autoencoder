...
parser.add_argument("--exp", default='eeg_small',
                    help='dataset [eeg/mnist/celebA/dsprites]')
...
def main():
    ...
    if FLAGS.exp == 'celebA':
        ...
        opts = configs.config_eeg
    elif FLAGS.exp == 'eeg_small':
        opts = configs.config_eeg_small
