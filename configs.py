...
# Toy BrainWave experiment
config_eeg_small = copy.deepcopy(config_eeg)
config_eeg_small['z_test'] = 'mmd'
config_eeg_small['g_arch'] = 'mlp'
config_eeg_small['e_arch'] = 'mlp'
config_eeg_small['g_num_layers'] = 3
config_eeg_small['g_num_filters'] = 256
config_eeg_small['e_num_layers'] = 3
config_eeg_small['e_num_filters'] = 256
config_eeg_small['print_every'] = 500
config_eeg_small['save_every_epoch'] = 1
config_eeg_small['lr_schedule'] = 'plateau'
config_eeg_small['epoch_num'] = 5
